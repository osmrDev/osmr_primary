...
function battleScreen_addHpInfo(chara, hbxLoc, hbyLoc) {
  ...
  hp_barHP.scale.set(.85*size, .85*size);
...
function battleScreen_updateHpInfo(chara) {
  ...
  hpbar.scale.set(.85*BattleScreen_hpInfo_charaHPinfoSize*(chara.hp_current/chara.hp_max), .85*BattleScreen_hpInfo_charaHPinfoSize);
}
